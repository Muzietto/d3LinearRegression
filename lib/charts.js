var OnebipCharts = function() {
  ...
  function paintTrendline(values) {
    ...
    for (var i = 1; i < values.length; i++) {
      ...
      // skip trendless datasets
      if (typeof minValuePointData.index === 'undefined' || typeof maxValuePointData.index === 'undefined') continue;
      ...
      trendline.enter()
        .append("line")
        .attr("class", "trendline-"+datasetName+" c3-target-"+datasetName)
